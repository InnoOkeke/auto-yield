    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
            ...
            <motion.button
                ...
                className="w-14 h-14 bg-primary-50 dark:bg-gradient-to-r dark:from-primary-600 dark:to-accent-600 text-primary-600 dark:text-white border border-primary-200 dark:border-transparent rounded-full shadow-lg flex items-center justify-center"
            >
                {isOpen ? (
